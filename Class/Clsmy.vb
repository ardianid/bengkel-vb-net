...
Public Class Clsmy
    ...
    Public Shared Function GetDataSet(ByVal SQL As String, ByVal cn As OleDbConnection, ByVal sqltrans As OleDbTransaction) As DataSet
    ...
    Public Shared Sub Insert_HistBarang(ByVal cn As OleDbConnection, ByVal sqltrans As OleDbTransaction, ByVal nobukti As String, _
                                        ByVal tanggal As String, ByVal kd_barang As String, ByVal jmlin As Integer, ByVal jmlout As Integer, ByVal jenis As String, ByVal nopol As String)

        Dim sql As String = String.Format("insert into hbarang_gudang (nobukti,tanggal,kd_barang,jmlin,jmlout,jenis,nopol) values('{0}','{1}','{2}',{3},{4},'{5}','{6}')", _
                                            nobukti, convert_date_to_eng(tanggal), kd_barang, jmlin, jmlout, jenis, nopol)
