...
Public Class fpr_belibyitem2
    ...
    Private Sub loadfaktur()
        ...
        Try
            ...
            Dim ds As DataSet = New ds_beli_byitem
            ...
            If jenislap = 0 Then
                ...
                Dim rinvoice As New r_beliitem With {.DataSource = ds.Tables(0)}
            ...
            Else
                ...
                Dim rinvoice As New r_beliitem2 With {.DataSource = ds.Tables(0)}
                rinvoice.xperiode.Text = periode
                rinvoice.xuser.Text = String.Format("User : {0} | Tgl : {1}", userprog, Date.Now)
                rinvoice.DataMember = rinvoice.DataMember
