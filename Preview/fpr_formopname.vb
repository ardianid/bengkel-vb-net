...
Public Class fpr_formopname
    ...
    Private Sub SimpleButton1_Click(sender As System.Object, e As System.EventArgs) Handles SimpleButton1.Click
        ...
        If CheckEdit1.Checked = True Then
            sql1 = "select kd_barang,nama_barang,0 as act,jmlstok1,jmlstok2 from ms_barang where jmlstok<>0"
        Else
            ...
            If XtraTabControl1.SelectedTabPageIndex = 0 Then
                ...
                sql1 = String.Format(" {0} and kd_barang in ( ", sql1)
            ...
            Else
                ...
                sql1 = String.Format(" {0} and kelompok in ( ", sql1)
