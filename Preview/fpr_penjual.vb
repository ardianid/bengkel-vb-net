...
Public Class fpr_penjual
    ...
    Private Sub loadfaktur()
        ...
        Try
            ...
            Dim ds As DataSet = New ds_penjual
            ds = Clsmy.GetDataSet("select kode,nama,alamat,notelp,convert(date,tgl_akhir)as tgl_akhir from ms_penjual", cn)
            ...
            Dim rinvoice As New r_penjual With {.DataSource = ds.Tables(0)}
