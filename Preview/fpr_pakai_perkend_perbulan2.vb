...
Public Class fpr_pakai_perkend_perbulan2
    ...
    Private Sub loadfaktur()
        ...
        Try
            ...
            Dim ds As DataSet = New ds_pakai_kend_perbulan
            ...
            Dim rinvoice As New r_pakai_kend_perbulan With {.DataSource = ds.Tables(0)}
            rinvoice.xuser.Text = String.Format("User : {0} | Tgl : {1}", userprog, Date.Now)
            rinvoice.xr_tahun.Text = periode
