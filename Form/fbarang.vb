...
Public Class fbarang
    ...
    Private Sub hapus()
        ...
        Try
            ...
            Dim sqlcek As String = String.Format("select noid from tr_pesanbeli2 where kd_barang='{0}'", dv1(Me.BindingContext(bs1).Position)("kd_barang").ToString)
            Dim sqlcek2 As String = String.Format("select noid from hbarang_gudang where kd_barang='{0}'", dv1(Me.BindingContext(bs1).Position)("kd_barang").ToString)

            Dim adacek1 As Boolean = False
            Dim adacek2 As Boolean = False

            Dim cmd1 As OleDbCommand = New OleDbCommand(sqlcek, cn)
            ...
            If adacek1 = True Or adacek2 = True Then
                MsgBox("Barang sudah ada dalam transaksi, tidak dapat dihapus..", vbOKOnly + vbExclamation, "Konfirmasi")
                Return
            End If
