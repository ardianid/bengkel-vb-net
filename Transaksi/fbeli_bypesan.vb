...
Public Class fbeli_bypesan
    ...
    Private Sub load_data()
        ...
        Try
            ...
            Dim sql As String = String.Format("select ms_barang.kd_barang,ms_barang.nama_barang,tr_pesanbeli2.qty,tr_pesanbeli2.satuan,tr_pesanbeli2.qtykecil,ms_barang.hargabeli as harga,ms_barang.qty1,ms_barang.qty2,tr_pesanbeli2.qty as qtyd,tr_pesanbeli2.qtykecil as qtydkecil,ms_barang.satuan1,ms_barang.satuan2,0.0 as disc_per,0 as disc_rp, " & _
            ...
            "end as jumlah,0 as qty_dt,0 as qty_dt2 " & _
            ...
            '"case when tr_pesanbeli2.qty_datang >= (ms_barang.qty1 * ms_barang.qty2) then " & _
            '" tr_pesanbeli2.qty_datang / (ms_barang.qty1 * ms_barang.qty2) else 0 end as qty_dt " & _
            '"case when tr_pesanbeli2.qty_datang >= (ms_barang.qty1 * ms_barang.qty2) and tr_pesanbeli2.qty_datang%(ms_barang.qty1 * ms_barang.qty2) > 0 then " & _
            '"tr_pesanbeli2.qty_datang%(ms_barang.qty1 * ms_barang.qty2) " & _
            '"when tr_pesanbeli2.qty_datang < (ms_barang.qty1 * ms_barang.qty2) then " & _
            '"tr_pesanbeli2.qty_datang end as qty_dt2,tr_pesanbeli2.qty_datang " & _
