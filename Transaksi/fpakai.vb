...
Public Class fpakai
    ...
    Private Sub opendata()
        ...
        "tr_pakai.note, tr_pakai.sbatal, ms_proyek.kd_group, ms_proyek.nama_group, ms_subproyek.kd_sub, ms_subproyek.nama_sub,tr_pakai.nopol,tr_pakai.tgl_masuk,tr_pakai.tgl_selesai,tr_pakai.lama_perbaikan " & _
    ...
    Private Sub cari()
        ...
        Select Case tcbofind.SelectedIndex
            ...
            Case 5
                sql = String.Format("{0} where tr_pakai.nobukti in (select nobukti from tr_pakai_mekanik where nama_mekanik like '%{1}%')", sql, tfind.Text.Trim)
            Case 6
                sql = String.Format("{0} where tr_pakai.note like '%{1}%'", sql, tfind.Text.Trim)
                'Case 5
        ...
        If drd.HasRows Then
            While drd.Read
                ...
                If IsNumeric(drd("noid").ToString) Then
                    ...
                    Clsmy.Insert_HistBarang(cn, sqltrans, nobukti, tanggal, kdbarang, qtykecil, 0, "Pemakaian (Batal)", nopol)
