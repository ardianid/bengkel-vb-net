...
Public Class fpesan_beli
    ...
    Private Sub tsview_Click(sender As System.Object, e As System.EventArgs) Handles tsview.Click
        ...
        Using fkar2 As New fpesan_beli2 With {.StartPosition = FormStartPosition.CenterParent, .dv = dv1, .addstat = False, .position = bs1.Position}
            ...
            fkar2.btadd_jasa.Enabled = False
            fkar2.btdel_jasa.Enabled = False
...
#Region "print_faktur"
    ...
    Private Sub loadfaktur_all(ByVal cn As OleDbConnection)
        ...
        "where tr_pesanbeli.sbatal=0  and tr_pesanbeli.nobukti='{0}'", nobukti)
...
#End Region
    ...
    Private Sub tsprint_Click(sender As System.Object, e As System.EventArgs) Handles tsprint.Click
        ...
        Using fkar2 As New fpr_buktipesan With {.WindowState = FormWindowState.Maximized, .sql1 = sql1, .sql2 = sql2, .nobukti = nobukti}
            fkar2.ShowDialog(Me)
        End Using
