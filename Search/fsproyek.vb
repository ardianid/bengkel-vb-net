...
Public Class fsproyek
    ...
    Private Sub cari()
        ...
        sql = "select kd_group,nama_group from ms_proyek"
        ...
        If Not tfind.Text.Trim.Equals("") Then
            ...
            Select Case cb_criteria.SelectedIndex
                Case 0
                    ...
                    sql = String.Format("{0} where  kd_group like '%{1}%'", sql, tfind.Text.Trim)

                Case 1

                    sql = String.Format("{0} where  nama_group like '%{1}%'", sql, tfind.Text.Trim)
        ...
        sql = String.Format(" {0} order by nama_group asc", sql)
    ...
    Public ReadOnly Property get_KODE As String
        Get
            ...
            If dv1.Count <= 0 Then
                ...
                Exit Property
            End If
            Return dv1(Me.BindingContext(dv1).Position)("kd_group").ToString
        End Get
    End Property
