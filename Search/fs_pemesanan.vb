...
Public Class fs_pemesanan
    ...
    Private Sub cari()
        ...
        Dim tanggal As String = DateAdd(DateInterval.Year, -1, Date.Now)
        ...
        "WHERE tr_pesanbeli.sbatal=0 and tr_pesanbeli.nobukti in ( " & _
        "select nobukti from v_pesan_pakai2 where jmlpesan > jmlpakai) " & _
        "and tr_pesanbeli.kd_toko='{0}' and tr_pesanbeli.tanggal>='{1}'", kd_toko, convert_date_to_eng(tanggal))
