...
Public Class fsbarang
    ...
    Private Sub cari()
        ...
        sql = "select kd_barang,nama_barang from ms_barang where saktif=1"
        ...
        If Not tfind.Text.Trim.Equals("") Then
            ...
            Select Case cb_criteria.SelectedIndex
                Case 0
                    ...
                    sql = String.Format("{0} and  kd_barang like '%{1}%'", sql, tfind.Text.Trim)

                Case 1

                    sql = String.Format("{0} and  nama_barang like '%{1}%'", sql, tfind.Text.Trim)
