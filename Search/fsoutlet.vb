...
Public Class fsoutlet
    ...
    Private Sub cari()
        ...
        sql = "select top 500 kode as kd_toko,nama as nama_toko,alamat as alamat_toko from ms_penjual"
        ...
        If Not tfind.Text.Trim.Equals("") Then
            ...
            Select Case cb_criteria.SelectedIndex
                Case 0
                    ...
                    sql = String.Format("{0} where  kode like '%{1}%'", sql, tfind.Text.Trim)

                Case 1

                    sql = String.Format("{0} where  nama like '%{1}%'", sql, tfind.Text.Trim)
       
                Case 2

                    sql = String.Format("{0} where  alamat like '%{1}%'", sql, tfind.Text.Trim)
        ...
        sql = String.Format(" {0} order by nama asc", sql)
